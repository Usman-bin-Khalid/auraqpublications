...
import 'discounted_books.dart';

class PublishedBooks extends StatefulWidget {
  final int currentIndex;
  PublishedBooks({this.currentIndex = 0});
  @override
  State<PublishedBooks> createState() => _GetInputState();
}
class _GetInputState extends State<PublishedBooks> {
  @override
    ...
    return Scaffold(
        ...
        leading: IconButton(
            onPressed: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => BookStoreDashboard()));
            },
            icon: Icon(
              Icons.arrow_back,
              color: Colors.black,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      BooksStore(model: BulkModel(), isUpdateMode: false)));
        },
      ...
      body: Column(
        children: [
          ...
          Expanded(child: _getBody(context)),
        ],
      ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () =>
                                  copyToClipboard(context,booklist.bookName == "" ? 'Auraq Book' : booklist.bookName.toString()),
                                  child: Text(
                                    booklist.bookName == ""
                                        ? "Auraq Book"
                                ...
                                GestureDetector(
                                  onTap: () =>
                                  copyToClipboard(context, booklist.authorName.toString()),
                                  child: Text(
                                ...
                                GestureDetector(
                                  onTap: () =>
                                  copyToClipboard(context, booklist.onDiscount!
                                      ? "Rs " + (booklist.grandtotalcost! *
                                      (1 -
                                          booklist.discount! / 100))
                                      .toStringAsFixed(0) +
                                      " PKR"
                                      :"Rs " + booklist.grandtotalcost!
                                      .toStringAsFixed(0) +
                                                        ...
                                                        onPressed: () {
                                                          ...
                                                          if (discountValue >=
                                                              ...
                                                              discountValue <
                                                                  100) {
                                                            setState(() {
                                                              booklist.setDiscount(
                                                                  discountValue
                                                                      .toDouble());
                                                              CalculatorServices()
                                                                  .markTaskAsCompletedAnyOne(
                                                                      booklist
                                                                          .docId
                                                                          .toString(),
                                                                      discountValue
                          ...
                          Container(
                            ...
                            child: CupertinoSwitch(
                                ...
                                onChanged: (val) {
                                  ...
                                  if (filteredTaskListOne[i].onDiscount ==
                                      false) {
                                    CalculatorServices()
                                        .markTaskAsCompletedAnyOne(
                                            booklist.docId.toString(),
