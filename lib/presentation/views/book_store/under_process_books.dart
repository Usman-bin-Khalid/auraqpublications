...
class UnderProcessBooks extends StatefulWidget{
  final int currentIndex;
  UnderProcessBooks({this.currentIndex = 0});
  @override
  State<UnderProcessBooks> createState() => _GetInputState();
}

class _GetInputState extends State<UnderProcessBooks> {
  @override
  ...
  Widget _getBody(BuildContext context) {
    return StreamProvider.value(value: CalculatorServices().getAllInCompletedTasksforAnyone(FirebaseAuth.instance.currentUser!.uid.toString()), initialData: [BulkModel()],
