...
class AvailableBooks extends StatefulWidget{
  @override
  State<AvailableBooks> createState() => _GetInputState();
}

class _GetInputState extends State<AvailableBooks> {
  @override
  ...
  Widget _getBody(BuildContext context) {
    return StreamProvider.value(value: CalculatorServices().getAllCompletedTasks(FirebaseAuth.instance.currentUser!.uid.toString()), initialData: [BulkModel()],
                              ...
                              children: [
                                ...
                                Text(
                                  task.onDiscount! ? "Rs " +  NumberFormat("#,##0").format(task.percopycost! * (1 -
                                      task.discount! / 100)) + " PKR" : "Rs " +
                                      NumberFormat("#,##0").format(task.percopycost!) + " PKR",
                                  style: TextStyle(
                                      fontSize: 12,
                                      color: Colors.blue,
                                      fontWeight: FontWeight.w200),
